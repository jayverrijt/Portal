...
namespace Portal.Data.Migrations
{
    ...
    [Migration("20260913211619_AddUserScopingAndSharing")]
    partial class AddUserScopingAndSharing
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Portal.Domain.Entities.ApplicationUser", b =>
                {
                    b.HasOne("Portal.Domain.Entities.Note", null)
                        .WithMany("SharedWithUsers")
                        .HasForeignKey("NoteId");

                    b.HasOne("Portal.Domain.Entities.Project", null)
                        .WithMany("SharedWithUsers")
            ...
            modelBuilder.Entity("Portal.Domain.Entities.Note", b =>
                {
                    b.HasOne("Portal.Domain.Entities.ApplicationUser", "Owner")
                        .WithMany()
